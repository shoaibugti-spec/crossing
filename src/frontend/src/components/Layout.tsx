...
import { Bell, Home, Menu, MessageCircle, Megaphone, Ads, User, X, ShoppingBag, Wallet as WalletIcon, HeadphonesIcon } from "lucide-react";
...
{isProvider ? (
            <Link to="/my-ads" className="flex-1">
              <div className="flex flex-col items-center gap-0.5 py-2.5">
                ...
                <span className="text-[10px] font-semibold text-gray-400 mt-0.5">My Ads</span>
              </div>
            </Link>
          ) : (
